...
---
> 💡 *Tài liệu được biên soạn dựa trên đặc tả của dự án Vòng 1 RTL Cuộc thi FPGA Mở Rộng 2026. Nếu có bất kỳ thắc mắc nào về luồng hoạt động, hãy tham chiếu log trên terminal giả lập.*# 📖 Wiki: Kiwi 1P5 Watchdog Monitor Simulator
